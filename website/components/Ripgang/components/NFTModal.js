                    ...
                    <Row className="d-flex justify-content-between align-items-center">
                        <Col xs={12} md={5} className="d-flex justify-content-center align-items-center">
                            <div className="flex-container m-0">
                                {props.video_url ? (
                                    <video className='videoTag w-full'
                                        autoPlay
                                        loop
                                        muted
                                        playsInline
                                    ...
                                    >
                                        <source src={`/ripgang/${props.video_url}`} type='video/mp4' />
                                    </video>
                                ) : (
                                    <img
                        ...
                        <Col xs={12} md={7} className="d-flex justify-content-center flex-wrap flex-column align-items-center">
                            ...
                            {props.description ? (
                                <>
                                    ...
                                    <Row className="d-flex align-items-center justify-content-between pt-2 w-full">
                                        <Col>
                                            <Button disabled={true} className="text-white w-100 button-mint h4">{props.price} ETH</Button>
                                        </Col>
                                        <Col>
                                            <Button disabled={true} className="text-white w-100 button-mint h4">{props.quantity} Un.</Button>
                                        </Col>
                                        <Col>
                                            <Button
                            ...
                            <span className="border-top text-white helvetica mb-3 mt-2 small pt-3">
                                Beneficio reclamable por única vez. Para más información dirigirse al discord oficial de la colección.
                            </span>
                        </Col>
                    </Row>
                </Container>
