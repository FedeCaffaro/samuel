  ...
  return (
    ...
    <Container fluid>
        ...
        {wallet && wallet.account && (
          <Button onClick={() => disconnect()} variant="outline-light" size="lg"><img src="/metamask.png" width="25px" /> {`${wallet.account.substr(0, 6)}...${wallet.account.substr(wallet.account.length - 4)}`}</Button>
        )}
      </Container>
    </div>
  )
